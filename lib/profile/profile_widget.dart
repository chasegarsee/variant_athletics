    ...
    return StreamBuilder<UsersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          body: StreamBuilder<List<CoachesRecord>>(
            stream: queryCoachesRecord(
              queryBuilder: (coachesRecord) => coachesRecord.where('uid',
                  isEqualTo: profileUsersRecord.coachUid != ''
                      ? profileUsersRecord.coachUid
                      : null),
              singleRecord: true,
            ),
            builder: (context, snapshot) {
                  ...
                  StreamBuilder<List<ProgramsRecord>>(
                    stream: queryProgramsRecord(
                      queryBuilder: (programsRecord) => programsRecord
                          .where('coachId', isEqualTo: stackCoachesRecord!.uid)
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Text(
                                          FFLocalizations.of(context).getText(
                                            'lw93b5fa' /* Notification Settings */,
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                              .bodyLarge,
                                        ),
                                  ...
                                  onTap: () async {
                                    context.pushNamed(
                                      ...
                                      extra: <String, dynamic>{
                                        'currentUser': profileUsersRecord,
                                        'currentCoach': stackCoachesRecord,
                                        'programIndex0':
                                            containerProgramsRecordList.first,
                                      },
                                    );
