  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<List<UsersRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsersRecord> newProgramUsersRecordList = snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final newProgramUsersRecord = newProgramUsersRecordList.isNotEmpty
            ? newProgramUsersRecordList.first
            : null;
                              ...
                              onPressed: () async {
                                await ProgramsRecord.collection
                                    ...
                                    .set(createProgramsRecordData(
                                      ...
                                      programPhotoUrl: _model.uploadedFileUrl,
                                      length: _model.durationController.text,
                                    ));
                                context.safePop();
                              },
