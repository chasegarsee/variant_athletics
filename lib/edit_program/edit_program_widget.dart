...
import '/components/delete_program_bottom_sheet_widget.dart';
              ...
              child: StreamBuilder<List<CoachesRecord>>(
                stream: queryCoachesRecord(
                  queryBuilder: (coachesRecord) => coachesRecord.where('uid',
                      isEqualTo: editProgramUsersRecord!.coachUid),
                  singleRecord: true,
                ),
                builder: (context, snapshot) {
                  // Customize what your widget looks like when it's loading.
                  ...
                  List<CoachesRecord> containerCoachesRecordList =
                      snapshot.data!;
                  // Return an empty Container when the item does not exist.
                  if (snapshot.data!.isEmpty) {
                    return Container();
                  }
                  final containerCoachesRecord =
                      containerCoachesRecordList.isNotEmpty
                          ? containerCoachesRecordList.first
                          : null;
                  return Container(
